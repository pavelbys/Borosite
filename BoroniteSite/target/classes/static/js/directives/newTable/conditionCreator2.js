app.directive('conditionCreator2', function () {
    "use strict";
    return {
        restrict: 'E',
        scope: true,
        ...
        link: function (scope) {
            scope.resultObjects = conditionObjectList;
            ...
            scope.addResult = function ()   {
                ...
                if(classNameList.contains(scope.currentObject.name))   {
                    ...
                    if(!attributeNameList.contains(scope.currentAttribute.name)) {
                     ...
                     scope.table.addConditionClass(scope.currentObject.name, [scope.currentAttribute.name]);
                }
